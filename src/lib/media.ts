...
export const VIDEO = {
  ...
  cookupBg: "/manus-storage/video/cookup-bg-outdoor.mp4",
...
export const VIDEO_POSTER = {
  ...
  cookupBgOutdoor: "/manus-storage/video/cookup-bg-outdoor.jpg",
...
export const VENUE: { src: string; alt: string; span?: string }[] = [
  ...
  // Pavilion seating sits directly beside the string-lit shot at the owner's
  // request; the deck-seating photo that used to hold this slot was dropped.
  // DSC00327 is still the page hero (PAGE_HERO_IMAGE), so the file stays put.
...
export const GALLERY: { src: string; alt: string; span?: string }[] = [
  ...
  { src: "/manus-storage/birthday-happy.jpg", alt: "Birthday party balloon backdrop" },
  { src: "/manus-storage/birthday-family.jpg", alt: "Family celebrating a birthday", span: "lg:col-span-2" },
  { src: "/manus-storage/birthday-football-table.jpg", alt: "Themed birthday dessert table" },
  { src: "/manus-storage/DSC00277-HDR.jpg", alt: "Walkway to the pavilion" },
